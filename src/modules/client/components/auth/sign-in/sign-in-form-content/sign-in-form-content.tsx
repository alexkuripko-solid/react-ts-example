...
import AppleAuthButton from "../../../../../../common/layouts/auth/apple-auth-button";
  ...
  return (
    <Form>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-around' }}>
        ...
        {/* <AppleAuthButton disabled={isSubmitting} /> */}
      </Box>
      <Button sx={{ mt: 6, mb: 3 }} type="submit" fullWidth variant="contained" disabled={isSubmitting}>
        Continue
      </Button>
