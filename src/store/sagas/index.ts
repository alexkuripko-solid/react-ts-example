...
import {
  APPLY_VERIFICATION_CODE_REQUEST, GET_AUTH_USER_REQUEST,
  LOGOUT_REQUEST,
...
import { GET_USERS_REQUEST, UPDATE_USER_REQUEST, DELETE_USER_REQUEST } from '../actions/users';
import { GET_PROVIDERS_REQUEST, UPDATE_PROVIDER_REQUEST, DELETE_PROVIDER_REQUEST } from '../actions/providers';
import {
  CREATE_APPOINTMENT_REQUEST,
  GET_APPOINTMENTS_REQUEST, REMOVE_APPOINTMENT_REQUEST,
