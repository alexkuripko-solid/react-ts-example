...
import {
  ...
  APPLY_VERIFICATION_CODE_SUCCESS, GET_AUTH_USER_FAILURE, GET_AUTH_USER_REQUEST, GET_AUTH_USER_SUCCESS,
  LOGOUT_FAILURE,
  LOGOUT_REQUEST,
  LOGOUT_SUCCESS,
...
export const sendVerificationCode = (callback: () => void): Action => ({
