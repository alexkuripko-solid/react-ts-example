    ...
    >
      <GridContainer container spacing={1}>
        <ItemCardInfo item lg={8} md={9} sm={12}>
          ...
          {dataMap.image &&  <Image sx={{ minWidth: imageSize, height: imageSize }} src={dataMap.image(item)} />}
          <Box>
    ...
    <ItemCard>
      <GridContainer container spacing={1}>
        <ItemCardInfo item lg={7} md={9} sm={12}>
          <Skeleton sx={{ borderRadius: 1, mr: 2 }} variant="rectangular" width={128} height={128} />
          <Box>
